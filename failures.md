...
| SHA extension instructions | `./build-release/remill-tester 3975WX/sha1msg2.txt 3975WX/sha1nexte.txt 3975WX/sha1rnds4.txt 3975WX/sha256msg1.txt 3975WX/sha256msg2.txt 3975WX/sha256rnds2.txt --execute` | pending re-audit after `sha1msg1` fix; remaining rows skipped as `sha_extension_unsupported` | `sha1msg1.txt` is fixed by Remill submodule commit `a227ce9` and now passes `63,904` rows. Remaining SHA extension semantics are still unsupported. |
